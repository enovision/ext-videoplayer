                ...
                !function (e, t) {
                    ...
                    function f (e) {
                        for (var t = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], n = _, r = Array.isArray(n), o = 0, n = r ? n : n[Symbol.iterator](); ;) {
                            ...
                            var a = i, u = e.getAttribute("data-vimeo-" + a);
                            (u || "" === u) && (t[a] = "" === u ? 1 : u)
                        }
                        return t
                    }
                    ...
                    function y (e, t) {
                        ...
                        var o = [], i = void 0;
                        if (t.event) {
                            if ("error" === t.event) for (var a = n(e, t.data.method), u = a, s = Array.isArray(u), c = 0, u = s ? u : u[Symbol.iterator](); ;) {
                                var f;
                                if (s) {
                                    if (c >= u.length) break;
                                    f = u[c++]
                                ...
                                var l = f, h = new Error(t.data.message);
                    ...
                    var m = "undefined" != typeof Array.prototype.indexOf, g = "undefined" != typeof window.postMessage;
                        ...
                        b = (e(function (e, t) {
                            !function (e) {
                                ...
                                function i (e, t) {
                                    ...
                                    if (t != t || 0 === t) for (g = e.length; g-- && !b(e[g], t);) ; else g = e.indexOf(t);
                                    return -1 < g
                                }
                                ...
                                var g, w = Object.defineProperty, b = function (e, t) {
                                    return e === t || e !== e && t !== t
                                };
                                ...
                                var i = new E(function (r, i) {
                                    var a = function (e) {
                                        if (s(e.origin) && t.element.contentWindow === e.source) {
                                            ...
                                            var n = p(e.data), o = "event" in n && "ready" === n.event,
